<?php /* Smarty version 2.6.18, created on 27-01-2015 21:16:59
         compiled from pages/interno/modulo/usuario/visualizacao.tpl */ ?>
...
" readonly=""/></td>
                ...
                <tr>
                    ...
                    <td><input type="text" id="formUsuario_Login" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['usuario']['login']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select id="formUsuario_Nivel">
                            <option value="" readonly=""><?php echo $this->_tpl_vars['usuario']['nivel']; ?>
</option>
                        </select>
                    </td>
                </tr>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formUsuario_Status" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['usuario']['status']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formUsuario_DataCadastro">Data de Cadastro:</label></td>
                    <td><input type="text" id="formUsuario_DataCadastro" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['usuario']['dataCadastro']; ?>
" readonly=""/></td>
                </tr>
            </table>
        </fieldset>
