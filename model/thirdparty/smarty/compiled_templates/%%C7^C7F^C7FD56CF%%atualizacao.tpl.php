<?php /* Smarty version 2.6.18, created on 09-04-2015 16:26:23
         compiled from pages/interno/modulo/curso/atualizacao.tpl */ ?>
<script type="text/javascript">
    $(function() {
    $("#tabs_atualizacaoCurso").tabs();
});
...
<script>$("#statusInformacao").html("Vocé está em: Curso >> Listar Cursos >> Atualizar Cadastro de Curso.");</script>

<div id="tabs_atualizacaoCurso">
    <ul>
                ...
                <tr>
                    ...
                    <td>
                        <select id="formCurso_TamanhoFonte">
                            <option value="<?php echo $this->_tpl_vars['curso']['tamanhoFonte']; ?>
"><?php echo $this->_tpl_vars['curso']['tamanhoFonte']; ?>
 px</option>
...
<table>
    <tr>
        <td><button id="<?php echo $this->_tpl_vars['curso']['idCurso']; ?>
...
interno/modulo/curso/atualizar",
                data: {
                    "idCurso": idCurso,
