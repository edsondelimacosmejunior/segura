<?php /* Smarty version 2.6.18, created on 18-07-2015 09:48:32
         compiled from pages/interno/modulo/usuario/atualizacao.tpl */ ?>
<script type="text/javascript">
    $(function() {
    $("#tabs_atualizacaoUsuario").tabs();
});
...
<script>$("#statusInformacao").html("Vocé está em: Usuário >> Listar Usuário >> Atualizar Cadastro de Usuário.");</script>

<div id="tabs_atualizacaoUsuario">
    <ul>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formUsuario_Nome" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['usuario']['nome']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formUsuario_Senha">Senha:</label></td>
                    <td><input type="password" id="formUsuario_Senha" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['usuario']['senha']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formUsuario_Senha2">Confirmar Senha:</label></td>
                    <td><input type="password" id="formUsuario_Senha2" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['usuario']['senha']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formUsuario_Email">Email:</label></td>
                    <td><input type="text" id="formUsuario_Email" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['usuario']['email']; ?>
"/></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="formUsuario_Nivel">
                            <option value="<?php echo $this->_tpl_vars['usuario']['nivel']; ?>
"><?php echo $this->_tpl_vars['usuario']['nivel']; ?>
</option>
...
<table>
    <tr>
        <td><button id="<?php echo $this->_tpl_vars['usuario']['idUsuario']; ?>
...
interno/modulo/usuario/atualizar",
                data: {
                    "idUsuario": idUsuario,
