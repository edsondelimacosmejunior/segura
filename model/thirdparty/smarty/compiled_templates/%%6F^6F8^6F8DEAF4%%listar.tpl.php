<?php /* Smarty version 2.6.18, created on 15-10-2015 01:02:44
         compiled from pages/interno/modulo/financeiro/formaPagamento/listar.tpl */ ?>
...
<div id="resultado-contain">
    ...
    <table id="resultado">
        ...
        <tbody id="conteudoResultado">
            <?php $_from = $this->_tpl_vars['formaPagamentos']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['formaPagamentos']):
?>
            <tr>
                <td><?php echo $this->_tpl_vars['formaPagamentos']['idFormaPagamento']; ?>
</td>
                <td><?php echo $this->_tpl_vars['formaPagamentos']['nome']; ?>
</td>
                <td><?php echo $this->_tpl_vars['formaPagamentos']['descricao']; ?>
</td>
                <td><?php echo $this->_tpl_vars['formaPagamentos']['usuarioCriacao']; ?>
</td>
                <td><?php echo $this->_tpl_vars['formaPagamentos']['dataCriacao']; ?>
</td>
                <td>
                    <button id="<?php echo $this->_tpl_vars['formaPagamentos']['idFormaPagamento']; ?>
" onclick="javascript:abreEditarFormaPagamento(this);" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" style="cursor:pointer;" title="Atualizar"><img src="<?php echo $this->_tpl_vars['IMG']; ?>
...
interno/modulo/financeiro/formapagamento/buscar",
            data: {
    ...
    function gravarFormaPagamento() {
        ...
        if (contador == 0) {
            ...
            $.ajax({
                url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/formapagamento/cadastrar",
                data: {
...
interno/modulo/financeiro/formapagamento/listar/");
                },
                error: function (data) {
                    respostaDoControlador = eval(data);
                    $().message(respostaDoControlador.message);
    ...
    function editarFormaPagamento() {
        ...
        if (contador == 0) {
            ...
            $.ajax({
                url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/formapagamento/editar",
                data: {
...
interno/modulo/financeiro/formapagamento/listar/");
    ...
    function confirmarExclusaoFormaPagamento() {
        openlink('<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/formapagamento/excluir/' + $("#auxDialogsFormaPagamento").val())
        openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/formapagamento/listar/");
    }
