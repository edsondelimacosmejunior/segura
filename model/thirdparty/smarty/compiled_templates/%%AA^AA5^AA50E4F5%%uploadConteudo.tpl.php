<?php /* Smarty version 2.6.18, created on 03-02-2015 03:07:58
         compiled from pages/interno/modulo/curso/uploadConteudo.tpl */ ?>
...
<script>$("#statusInformacao").html("Você está em: Cursos>> Listar >> Upload de Conteúdo.");</script>

<input type="text" id="idCurso" name="idCurso" value="<?php echo $this->_tpl_vars['curso']['idCurso']; ?>
" style="display: none;" />
            ...
            <tr>
                <td>
                    <fieldset style="background-color: whitesmoke;">
                        <legend>Associar a:  
                            <?php echo $this->_tpl_vars['curso']['nome']; ?>
...
interno/modulo/curso/uploadConteudo" method="post">
                            <input type="hidden" name="MAX_FILE_SIZE" value="30000000" />
                            <input type="hidden" id="uploadConteudoCurso_nomeUpload" name="uploadConteudoCurso_nomeUpload" />
                            Arquivo do Conteúdo: <input name="userfile" type="file" id="userfile" onchange="valida();" />
...
interno/modulo/curso/armazenarConteudo",
                data: {
                    "idCurso": $("#idCurso").val(),
                    "extensao": ($("#userfile").val().substring($("#userfile").val().lastIndexOf("."))).toLowerCase()
                },
                ...
                success: function(data) {
                    ...
                    $('#porcentagem').html('80%');
                    $('#uploadConteudoCurso_nomeUpload').val(respostaDoControlador.message);
