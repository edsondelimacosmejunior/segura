<?php /* Smarty version 2.6.18, created on 27-11-2015 17:16:35
         compiled from pages/interno/modulo/financeiro/relatorios/fluxoCaixa.tpl */ ?>
...
interno/modulo/financeiro/relatorios/fluxocaixa/filtrar/",
            data: {
                "mes": $("#mes").val(),
                "ano": $("#ano").val()
            },
...
<script>
    ...
    function getReceitas(idTipoLancamento, dia, mes, ano) {
        ...
        $.ajax({
            url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixa/getReceitas",
            data: {
    ...
    function getDespesas(idTipoLancamento, dia, mes, ano) {
        ...
        $.ajax({
            url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixa/getDespesas",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "dia": dia,
                "mes": mes,
    ...
    function getReceitasTotal(idTipoLancamento, mes, ano) {
        ...
        $.ajax({
            url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixa/getReceitasTotal",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "mes": mes,
                "ano": ano
    ...
    function getDespesasTotal(idTipoLancamento, mes, ano) {
        ...
        $.ajax({
            url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixa/getDespesasTotal",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "mes": mes,
                "ano": ano
...
<script>$("#statusInformacao").html("Você está em: Financeiro >> Caixa >> Fluxo de Caixa.");</script>
