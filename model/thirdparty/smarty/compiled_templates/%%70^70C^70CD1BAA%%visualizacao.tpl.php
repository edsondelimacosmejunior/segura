<?php /* Smarty version 2.6.18, created on 15-04-2015 13:22:22
         compiled from pages/interno/modulo/curso/visualizacao.tpl */ ?>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formCurso_Nome" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['curso']['nome']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_CargaHoraria">Carga Horária:</label></td>
                    <td><input type="text" id="formCurso_CargaHoraria" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['curso']['cargaHoraria']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_Conteudo">Conteúdo:</label></td>
                    <td><input type="text" id="formCurso_Conteudo" size="70" value="<?php echo $this->_tpl_vars['curso']['conteudo']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_PatchConteudo">Conteúdo (Imagem):</label></td>
                    <td><input type="text" id="formCurso_PatchConteudo" size="70" value="<?php echo $this->_tpl_vars['curso']['patchConteudo']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_Validade">Validade:</label></td>
                    <td><input type="text" id="formCurso_Validade" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['curso']['validade']; ?>
" readonly=""/></td>
                </tr>                
            </table>
        </fieldset>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table>    
                <tr>
                    ...
                    <td><input type="color" id="formCurso_CorFundo" size="70" value="<?php echo $this->_tpl_vars['curso']['corFundo']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_CorFonte">Cor da Fonte do Título:</label></td>
                    <td><input type="color" id="formCurso_CorFonte" size="70" value="<?php echo $this->_tpl_vars['curso']['corFonte']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_TamanhoFonte">Tamanho da Fonte do Título:</label></td>
                    <td><input type="text" id="formCurso_TamanhoFonte" size="70" value="<?php echo $this->_tpl_vars['curso']['tamanhoFonte']; ?>
" readonly=""/></td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formCurso_Status" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['curso']['status']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_UsuarioResponsavel">Usuário Responsável:</label></td>
                    <td><input type="text" id="formCurso_UsuarioResponsavel" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['curso']['usuarioResponsavel']; ?>
" readonly=""/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_DataCadastro">Data de Cadastro:</label></td>
                    <td><input type="text" id="formCurso_DataCadastro" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['curso']['dataCadastro']; ?>
" readonly=""/></td>
                </tr>
            </table>
        </fieldset>
