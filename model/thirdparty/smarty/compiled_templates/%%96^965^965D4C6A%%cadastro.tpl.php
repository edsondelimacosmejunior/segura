<?php /* Smarty version 2.6.18, created on 09-03-2015 13:16:30
         compiled from pages/interno/modulo/instrutor/cadastro.tpl */ ?>
<script type="text/javascript">
    $(function() {
    $("#tabs_cadastroInstrutor").tabs();
});
...
<script>$("#statusInformacao").html("Vocé está em: Instrutor >> Cadastro de Instrutor.");</script>

<div id="tabs_cadastroInstrutor">
    <ul>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Nome" size="70" maxlength="255"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Cpf" size="70" maxlength="14" onKeyDown="Mascara(this,Cpf);" onKeyPress="Mascara(this,Cpf);" onKeyUp="Mascara(this,Cpf);"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Rg">RG:</label></td>
                    <td><input type="text" id="formInstrutor_Rg" size="70" maxlength="45" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_DataNascimento">Data de Nascimento:</label></td>
                    <td><input type="text" id="formInstrutor_DataNascimento" size="70" maxlength="10" onKeyDown="Mascara(this,Data);" onKeyPress="Mascara(this,Data);" onKeyUp="Mascara(this,Data);"/></td>
                </tr>
            </table>
        </fieldset>
    </div>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Rua" size="70" maxlength="255"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Numero">Número:</label></td>
                    <td><input type="text" id="formInstrutor_Numero" size="70" maxlength="10" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Bairro">Bairro:</label></td>
                    <td><input type="text" id="formInstrutor_Bairro" size="70" maxlength="255"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Cep">CEP:</label></td>
                    <td><input type="text" id="formInstrutor_Cep" size="70" maxlength="9" onKeyDown="Mascara(this,Cep);" onKeyPress="Mascara(this,Cep);" onKeyUp="Mascara(this,Cep);"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Cidade">Cidade:</label></td>
                    <td><input type="text" id="formInstrutor_Cidade" size="70" maxlength="255"/></td>
                </tr>
                <tr>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Email" size="70" maxlength="255"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Telefone1">Telefone Principal:</label></td>
                    <td><input type="text" id="formInstrutor_Telefone1" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Telefone2">Telefone Secundário:</label></td>
                    <td><input type="text" id="formInstrutor_Telefone2" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Formacao" size="70" maxlength="255"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_NumeroRegistro">Número do Registro:</label></td>
                    <td><input type="text" id="formInstrutor_NumeroRegistro" size="70" maxlength="255"/></td>
                </tr>
            </table>
        </fieldset>
    </div>
...
interno/modulo/instrutor/cadastrar",
                data: {
                ...
                success: function(data){
                    ...
                    if(mensagem == "Instrutor cadastrado com sucesso."){
