<?php /* Smarty version 2.6.18, created on 27-11-2015 17:33:06
         compiled from pages/interno/modulo/financeiro/relatorios/fluxoCaixaSede.tpl */ ?>
...
interno/modulo/financeiro/relatorios/fluxocaixasede/filtrar/",
            data: {
                "mes": $("#mes").val(),
                "ano": $("#ano").val()
            },
...
interno/modulo/financeiro/relatorios/fluxocaixasede/mostrar/");
    }
...
<script>
    ...
    function getReceitas(idTipoLancamento, dia, mes, ano) {
        ...
        $.ajax({
            url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixasede/getReceitas",
            data: {
    ...
    function getDespesas(idTipoLancamento, dia, mes, ano) {
        ...
        $.ajax({
            url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixasede/getDespesas",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "dia": dia,
                "mes": mes,
    ...
    function getReceitasTotal(idTipoLancamento, mes, ano) {
        ...
        $.ajax({
            url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixasede/getReceitasTotal",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "mes": mes,
                "ano": ano
    ...
    function getDespesasTotal(idTipoLancamento, mes, ano) {
        ...
        $.ajax({
            url: "<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixasede/getDespesasTotal",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "mes": mes,
                "ano": ano
...
<script>$("#statusInformacao").html("Você está em: Financeiro >> Caixa >> Fluxo de Caixa da Sede.");</script>
...
<div id="tabs_fluxoCaixa">
    <ul>
        <li><a href="#tabs-1">Fluxo de Caixa da Sede</a></li>
    </ul>
    <div id="tabs-1">
...
?>
 ...
 (<?php echo $this->_tpl_vars['cal']['DIA']; ?>
                ...
                <tbody style="margin-bottom: 30px;">
                    <?php $_from = $this->_tpl_vars['tiposLancamentosReceitas']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?>
 ...
 (<?php echo $this->_tpl_vars['cal']['DIA']; ?>
                ...
                <tbody style="margin-bottom: 30px;">
                    <?php $_from = $this->_tpl_vars['tiposLancamentosDespesas']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['tip']):
?>
                    <tr>
                        <td style="width: 150px;"><?php echo $this->_tpl_vars['tip']['nome']; ?>
