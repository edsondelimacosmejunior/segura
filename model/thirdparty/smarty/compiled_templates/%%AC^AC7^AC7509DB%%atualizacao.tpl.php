<?php /* Smarty version 2.6.18, created on 09-07-2015 08:26:38
         compiled from pages/interno/modulo/aluno/atualizacao.tpl */ ?>
<script type="text/javascript">
    $(function() {
    $("#tabs_atualizacaoAluno").tabs();
});
...
<script>$("#statusInformacao").html("Vocé está em: Aluno >> Listar Alunos >> Atualizar Cadastro de Aluno.");</script>

<div id="tabs_atualizacaoAluno">
    <ul>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formAluno_Nome" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['aluno']['nome']; ?>
"/></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="formAluno_Sexo">
                            <option value="<?php echo $this->_tpl_vars['aluno']['sexo']; ?>
"><?php echo $this->_tpl_vars['aluno']['sexo']; ?>
</option>
                ...
                <tr>
                    ...
                    <td><input type="text" id="formAluno_Cpf" size="70" maxlength="14" onKeyDown="Mascara(this,Cpf);" onKeyPress="Mascara(this,Cpf);" onKeyUp="Mascara(this,Cpf);" value="<?php echo $this->_tpl_vars['aluno']['cpf']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Matricula">Matrícula:</label></td>
                    <td><input type="text" id="formAluno_Matricula" size="70" maxlength="7" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="<?php echo $this->_tpl_vars['aluno']['matricula']; ?>
"/></td>
                </tr>                
                <tr>
                    <td><label for="formAluno_Rg">RG:</label></td>
                    <td><input type="text" id="formAluno_Rg" size="70" maxlength="45" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="<?php echo $this->_tpl_vars['aluno']['rg']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_DataNascimento">Data de Nascimento:</label></td>
                    <td><input type="text" id="formAluno_DataNascimento" size="70" maxlength="10" onKeyDown="Mascara(this,Data);" onKeyPress="Mascara(this,Data);" onKeyUp="Mascara(this,Data);" value="<?php echo $this->_tpl_vars['aluno']['dataNascimento']; ?>
"/></td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formAluno_Rua" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['aluno']['rua']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Numero">Número:</label></td>
                    <td><input type="text" id="formAluno_Numero" size="70" maxlength="255" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="<?php echo $this->_tpl_vars['aluno']['numero']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Bairro">Bairro:</label></td>
                    <td><input type="text" id="formAluno_Bairro" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['aluno']['bairro']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Cep">CEP:</label></td>
                    <td><input type="text" id="formAluno_Cep" size="70" maxlength="9" onKeyDown="Mascara(this,Cep);" onKeyPress="Mascara(this,Cep);" onKeyUp="Mascara(this,Cep);" value="<?php echo $this->_tpl_vars['aluno']['cep']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Cidade">Cidade:</label></td>
                    <td><input type="text" id="formAluno_Cidade" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['aluno']['cidade']; ?>
"/></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="formAluno_Uf">
                            <option value="<?php echo $this->_tpl_vars['aluno']['uf']; ?>
"><?php echo $this->_tpl_vars['aluno']['uf']; ?>
</option>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formAluno_Email" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['aluno']['email']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Telefone1">Telefone Principal:</label></td>
                    <td><input type="text" id="formAluno_Telefone1" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="<?php echo $this->_tpl_vars['aluno']['telefone1']; ?>
"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Telefone2">Telefone Secundário:</label></td>
                    <td><input type="text" id="formAluno_Telefone2" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="<?php echo $this->_tpl_vars['aluno']['telefone2']; ?>
"/></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="formAluno_Escolaridade">
                            <option value="<?php echo $this->_tpl_vars['aluno']['escolaridade']; ?>
"><?php echo $this->_tpl_vars['aluno']['escolaridade']; ?>
</option>
                ...
                <tr>
                    ...
                    <td>
                        <select id="formAluno_Vinculo" class="text ui-widget-content ui-corner-all">
                            <option value="<?php echo $this->_tpl_vars['aluno']['vinculo']; ?>
"><?php echo $this->_tpl_vars['aluno']['vinculo']; ?>
</option>
...
<table>
    <tr>
        <td><button id="<?php echo $this->_tpl_vars['aluno']['idAluno']; ?>
...
interno/modulo/aluno/atualizar",
                data: {
                    "idAluno": idAluno,
