<?php /* Smarty version 2.6.18, created on 27-11-2015 17:33:01
                ...
                <ul>
                    ...
                    <li><a class="parent"><span>Relatórios</span></a>
                        <ul>
                            ...
                            <li><a href="javascript:menu_mostrarRelatorioFluxoCaixaSede();"><span>Fluxo de Caixa da Sede</span></a></li>
...
interno/modulo/empresa/listarEmpresas/");
    ...
    function menu_cadastrarTipoLancamento() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/tipolancamento/abrirFormulario/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
...
interno/modulo/financeiro/centrocusto/listar/")
    ...
    function menu_cadastrarFormaPagamento() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/formapagamento/abrirFormulario/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
...
interno/modulo/financeiro/formapagamento/listar/")
    ...
    function menu_cadastrarLancamentoFinanceiro() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/lancamentofinanceiro/abrirFormulario/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
...
interno/modulo/financeiro/lancamentofinanceiro/listar/")
    ...
    function menu_mostrarRelatorioDespesa() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/despesa/mostrar/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
    ...
    function menu_mostrarRelatorioReceita() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/receita/mostrar/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
    ...
    function menu_mostrarRelatorioContasPagar() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/contaspagar/mostrar/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
    ...
    function menu_mostrarRelatorioContasPagas() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/contaspagas/mostrar/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
    ...
    function menu_mostrarRelatorioContasReceber() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/contasreceber/mostrar/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
...
interno/modulo/financeiro/relatorios/contasrecebidas/mostrar/")
    ...
    function menu_mostrarRelatorioFluxoCaixa() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
interno/modulo/financeiro/relatorios/fluxocaixa/mostrar/")
        } else {
            $().message("Você não tem acesso a essa funcionalidade. Caso necessite, entre em contato com o departamento de Tecnologia da Informação.");
        }
    }
    
    function menu_mostrarRelatorioFluxoCaixaSede() {
        if ($("#menu_nivelAcesso").val() == "Admin") {
            openlink("<?php echo $this->_tpl_vars['BASE_PATH']; ?>
