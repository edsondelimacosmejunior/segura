...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $template_header = "<?php /* Smarty version ".$this->_version.", created on ".strftime("%d-%m-%Y %H:%M:%S")."\n";
        //$template_header = "<?php /* Smarty version ".$this->_version.", created on ".date_default_timezone_set()."\n";
