...
abstract class BaseAluno extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('idAluno', 'integer', 4, array('type' => 'integer', 'length' => 4, 'primary' => true, 'autoincrement' => true));
        ...
        $this->hasColumn('matricula', 'string', 255, array('type' => 'string', 'length' => 255, 'notnull' => true));
        ...
        $this->hasColumn('vinculo', 'string', 255, array('type' => 'string', 'length' => 255, 'default' => '0', 'notnull' => true));
