 ...
 * @property string $areaInteresse
 * @property string $prospeccao
 ...
 */
abstract class BaseTalento extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('talento');
        $this->hasColumn('idTalento', 'integer', 4, array('type' => 'integer', 'length' => 4, 'primary' => true, 'autoincrement' => true));
        ...
        $this->hasColumn('areaInteresse', 'string', null, array('type' => 'string'));
        $this->hasColumn('prospeccao', 'string', null, array('type' => 'string'));
