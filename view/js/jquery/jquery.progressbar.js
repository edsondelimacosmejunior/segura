	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '../view/imgs/jquery/progressbar/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'../view/imgs/jquery/progressbar/progressbg_red.gif',
									30: '../view/imgs/jquery/progressbar/progressbg_orange.gif',
									70: '../view/imgs/jquery/progressbar/progressbg_green.gif'
								},
