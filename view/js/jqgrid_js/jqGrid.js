...
{
    var pathtojsfiles = "/transito/view/scripts/jqgrid_js/"; // need to be ajusted
    ...
    var minver = true;
    var modules = [
        { include: true, incfile:'grid.locale-pt-br.js',minfile: 'min/grid.locale-pt-br-min.js'}, // jqGrid translation
