        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formUsuario_Nome" size="70" maxlength="255" value="{{$usuario.nome}}"/></td>
                </tr>
                <tr>
                    <td><label for="formUsuario_Senha">Senha:</label></td>
                    <td><input type="password" id="formUsuario_Senha" size="70" maxlength="255" value="{{$usuario.senha}}"/></td>
                </tr>
                <tr>
                    <td><label for="formUsuario_Senha2">Confirmar Senha:</label></td>
                    <td><input type="password" id="formUsuario_Senha2" size="70" maxlength="255" value="{{$usuario.senha}}"/></td>
                </tr>
                <tr>
                    <td><label for="formUsuario_Email">Email:</label></td>
                    <td><input type="text" id="formUsuario_Email" size="70" maxlength="255" value="{{$usuario.email}}"/></td>
                </tr>
                <tr>
...
<table>
    <tr>
        <td><button id="{{$usuario.idUsuario}}" onclick="atualizar(id)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all">Atualizar</button></td>
...
<script>
    ...
    function atualizar(idUsuario){
      ...
      $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/usuario/atualizar",
                data: {
                    "idUsuario": idUsuario,
