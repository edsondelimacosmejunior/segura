        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td>
                        <select id="formTurma_Curso" class="text ui-widget-content ui-corner-all">
                            <option value="{{$turma.idCurso}}">{{$turma.idCurso}}</option>
                ...
                <tr>
                    ...
                    <td>
                        <select id="formTurma_Instrutor1" class="text ui-widget-content ui-corner-all">
                            <option value="{{$turma.idInstrutor1}}">{{$turma.idInstrutor1}}</option>
                ...
                <tr>
                    ...
                    <td>
                        <select id="formTurma_Instrutor2" class="text ui-widget-content ui-corner-all">
                            <option value="{{$turma.idInstrutor2}}">{{$turma.idInstrutor2}}</option>
                            <option value="">Retirar Instrutor</option>
                ...
                <tr>
                    ...
                    <td>
                        <select id="formTurma_Instrutor3" class="text ui-widget-content ui-corner-all">
                            <option value="{{$turma.idInstrutor3}}">{{$turma.idInstrutor3}}</option>
                            <option value="">Retirar Instrutor</option>
                ...
                <tr>
                    ...
                    <td>
                        <select id="formTurma_Instrutor4" class="text ui-widget-content ui-corner-all">
                            <option value="{{$turma.idInstrutor4}}">{{$turma.idInstrutor4}}</option>
                            <option value="">Retirar Instrutor</option>
                ...
                <tr>
                    ...
                    <td><input type="text" id="formTurma_Nome" size="70" maxlength="255" value="{{$turma.nome}}"/></td>
                </tr>
                <tr>
                    <td><label for="formTurma_Periodo">Período:</label></td>
                    <td><input type="text" id="formTurma_Periodo" size="70" maxlength="255" value="{{$turma.periodo}}"/></td>
                </tr>
                <tr>
                    <td><label for="formTurma_Local">Local:</label></td>
                    <td><input type="text" id="formTurma_Local" size="70" maxlength="255" value="{{$turma.local}}"/></td>
                </tr>
                <tr>
                    <td><label for="formTurma_Data">Data de Conclusão:</label></td>
                    <td><input type="text" id="formTurma_Data" size="70" maxlength="10" onKeyDown="Mascara(this,Data);" onKeyPress="Mascara(this,Data);" onKeyUp="Mascara(this,Data);" value="{{$turma.dataTurma}}"/></td>
                </tr>
                <tr>
                    <td><label for="formTurma_Valor">Valor: R$</label></td>
                    <td><input type="text" id="formTurma_Valor" size="70" maxlength="255" onKeyDown="Mascara(this, Moeda);" onKeyPress="Mascara(this, Moeda);" onKeyUp="Mascara(this, Moeda);" value="{{$turma.valor}}"/></td>
                </tr>
            </table>
        </fieldset>
    </div>
...
<table>
    <tr>
        <td><button id="{{$turma.idTurma}}" onclick="atualizar(id)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" >Atualizar</button></td>
...
<script>
    ...
    function atualizar(idTurma){
      ...
      $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/turma/atualizar",
                data: {
                    "idTurma": idTurma,
