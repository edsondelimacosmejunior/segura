...
<script>$("#statusInformacao").html("Você está em: Instrutores >> Listar >> Upload de Contrato.");</script>
            ...
            <tr>
                <td>
                    ...
                    <fieldset style="background-color: whitesmoke;">
                        ...
                        <form enctype="multipart/form-data" id="form" action="{{$BASE_PATH}}interno/modulo/instrutor/uploadContrato" method="post">
                            <input type="hidden" name="MAX_FILE_SIZE" value="30000000" />
                            <input type="hidden" id="uploadContratoInstrutor_nomeUpload" name="uploadContratoInstrutor_nomeUpload" />
                            Arquivo do Contrato: <input name="userfile" type="file" id="userfile" onchange="valida();" />
...
<script type="text/javascript" charset="utf-8">
    ...
    function cadastrar() {
        ...
        if (contador == 0) {
            ...
            //ESTA FUNÇÃO
            $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/instrutor/armazenarContrato",
                data: {
                ...
                success: function(data) {
                    ...
                    $('#porcentagem').html('80%');
                    $('#uploadContratoInstrutor_nomeUpload').val(respostaDoControlador.message);
