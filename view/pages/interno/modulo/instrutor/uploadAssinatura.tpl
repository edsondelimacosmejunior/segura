            ...
            <tr>
                <td>
                    ...
                    <fieldset style="background-color: whitesmoke;">
                        ...
                        <form enctype="multipart/form-data" id="form" action="{{$BASE_PATH}}interno/modulo/instrutor/uploadAssinatura" method="post">
...
<script type="text/javascript" charset="utf-8">
    ...
    function cadastrar() {
        ...
        if (contador == 0) {
            ...
            //ESTA FUNÇÃO
            $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/instrutor/armazenarAssinatura",
                data: {
