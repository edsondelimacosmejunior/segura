        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Nome" size="70" maxlength="255" value="{{$instrutor.nome}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Sexo">Sexo:</label></td>
                    <td>
                        <select id="formInstrutor_Sexo">
                            <option value="{{$instrutor.sexo}}">{{$instrutor.sexo}}</option>
                ...
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Cpf" size="70" maxlength="14" onKeyDown="Mascara(this,Cpf);" onKeyPress="Mascara(this,Cpf);" onKeyUp="Mascara(this,Cpf);" value="{{$instrutor.cpf}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Rg">RG:</label></td>
                    <td><input type="text" id="formInstrutor_Rg" size="70" maxlength="45" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="{{$instrutor.rg}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_DataNascimento">Data de Nascimento:</label></td>
                    <td><input type="text" id="formInstrutor_DataNascimento" size="70" maxlength="10" onKeyDown="Mascara(this,Data);" onKeyPress="Mascara(this,Data);" onKeyUp="Mascara(this,Data);" value="{{$instrutor.dataNascimento}}"/></td>
                </tr>
            </table>
        </fieldset>
    </div>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Rua" size="70" maxlength="255" value="{{$instrutor.rua}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Numero">Número:</label></td>
                    <td><input type="text" id="formInstrutor_Numero" size="70" maxlength="10" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="{{$instrutor.numero}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Bairro">Bairro:</label></td>
                    <td><input type="text" id="formInstrutor_Bairro" size="70" maxlength="255" value="{{$instrutor.bairro}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Cep">CEP:</label></td>
                    <td><input type="text" id="formInstrutor_Cep" size="70" maxlength="9" onKeyDown="Mascara(this,Cep);" onKeyPress="Mascara(this,Cep);" onKeyUp="Mascara(this,Cep);" value="{{$instrutor.cep}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Cidade">Cidade:</label></td>
                    <td><input type="text" id="formInstrutor_Cidade" size="70" maxlength="255" value="{{$instrutor.cidade}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Uf">UF:</label></td>
                    <td>
                        <select id="formInstrutor_Uf">
                            <option value="{{$instrutor.uf}}">{{$instrutor.uf}}</option>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Email" size="70" maxlength="255" value="{{$instrutor.email}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Telefone1">Telefone Principal:</label></td>
                    <td><input type="text" id="formInstrutor_Telefone1" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="{{$instrutor.telefone1}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Telefone2">Telefone Secundário:</label></td>
                    <td><input type="text" id="formInstrutor_Telefone2" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="{{$instrutor.telefone2}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_Escolaridade">Escolaridade:</label></td>
                    <td>
                        <select id="formInstrutor_Escolaridade">
                            <option value="{{$instrutor.escolaridade}}">{{$instrutor.escolaridade}}</option>
                ...
                <tr>
                    ...
                    <td><input type="text" id="formInstrutor_Formacao" size="70" maxlength="255" value="{{$instrutor.formacao}}"/></td>
                </tr>
                <tr>
                    <td><label for="formInstrutor_NumeroRegistro">Número do Registro:</label></td>
                    <td><input type="text" id="formInstrutor_NumeroRegistro" size="70" maxlength="255" value="{{$instrutor.numeroRegistro}}"/></td>
                </tr>
            </table>
        </fieldset>
    </div>
...
<table>
    <tr>
        <td><button id="{{$instrutor.idInstrutor}}" onclick="atualizar(id)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all">Atualizar</button></td>
...
<script>
    ...
    function atualizar(idInstrutor){
        ...
        $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/instrutor/atualizar",
                data: {
