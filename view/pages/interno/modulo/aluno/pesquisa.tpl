...
<script type="text/javascript" charset="utf-8">
    ...
    function getAluno() {
        ...
        if (contador == 0) {
            ...
            $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/aluno/getAlunos",
                data: {
                    "nome": $("#nome").val(),
                    "cpf": $("#cpf").val(),
                    "rg": $("#rg").val()
                ...
                success: function(data) {
                    ...
                    '<button id=' + data[i].idAluno + ' onclick="visualizar(this)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" style="cursor:pointer;" title="Visualizar"><img src="{{$IMG}}../imgs/visualizar.png"></button>'+
                    '<button id=' + data[i].idAluno + ' onclick="atualizar(this)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" style="cursor:pointer;" title="Atualizar"><img src="{{$IMG}}../imgs/atualizar.png"></button>'+
                    '<button id=' + data[i].idAluno + ' onclick="abrirExcluir(this)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" style="cursor:pointer;" title="Excluir"><img src="{{$IMG}}../imgs/excluir.png"></button>'+
                    '<button id=' + data[i].idAluno + ' onclick="cursos(this)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" style="cursor:pointer;" title="Turmas"><img src="{{$IMG}}../imgs/concluido.png"></button></td></tr>';
                        }
                        $("#alunosResultado").append(newRowContent);
                    } else {
