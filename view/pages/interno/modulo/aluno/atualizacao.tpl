        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formAluno_Nome" size="70" maxlength="255" value="{{$aluno.nome}}"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="formAluno_Cpf" size="70" maxlength="14" onKeyDown="Mascara(this,Cpf);" onKeyPress="Mascara(this,Cpf);" onKeyUp="Mascara(this,Cpf);" value="{{$aluno.cpf}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Matricula">Matrícula:</label></td>
                    <td><input type="text" id="formAluno_Matricula" size="70" maxlength="7" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="{{$aluno.matricula}}"/></td>
                </tr>                
                <tr>
                    <td><label for="formAluno_Rg">RG:</label></td>
                    <td><input type="text" id="formAluno_Rg" size="70" maxlength="45" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="{{$aluno.rg}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_DataNascimento">Data de Nascimento:</label></td>
                    <td><input type="text" id="formAluno_DataNascimento" size="70" maxlength="10" onKeyDown="Mascara(this,Data);" onKeyPress="Mascara(this,Data);" onKeyUp="Mascara(this,Data);" value="{{$aluno.dataNascimento}}"/></td>
                </tr>
            </table>
        </fieldset>
    </div>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formAluno_Rua" size="70" maxlength="255" value="{{$aluno.rua}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Numero">Número:</label></td>
                    <td><input type="text" id="formAluno_Numero" size="70" maxlength="255" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="{{$aluno.numero}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Bairro">Bairro:</label></td>
                    <td><input type="text" id="formAluno_Bairro" size="70" maxlength="255" value="{{$aluno.bairro}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Cep">CEP:</label></td>
                    <td><input type="text" id="formAluno_Cep" size="70" maxlength="9" onKeyDown="Mascara(this,Cep);" onKeyPress="Mascara(this,Cep);" onKeyUp="Mascara(this,Cep);" value="{{$aluno.cep}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Cidade">Cidade:</label></td>
                    <td><input type="text" id="formAluno_Cidade" size="70" maxlength="255" value="{{$aluno.cidade}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_UF">UF:</label></td>
                    <td>
                        <select id="formAluno_Uf">
                            <option value="{{$aluno.uf}}">{{$aluno.uf}}</option>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formAluno_Email" size="70" maxlength="255" value="{{$aluno.email}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Telefone1">Telefone Principal:</label></td>
                    <td><input type="text" id="formAluno_Telefone1" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="{{$aluno.telefone1}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Telefone2">Telefone Secundário:</label></td>
                    <td><input type="text" id="formAluno_Telefone2" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="{{$aluno.telefone2}}"/></td>
                </tr>
                <tr>
                    <td><label for="formAluno_Escolaridade">Escolaridade:</label></td>
                    <td>
                        <select id="formAluno_Escolaridade">
                            <option value="{{$aluno.escolaridade}}">{{$aluno.escolaridade}}</option>
                ...
                <tr>
                    ...
                    <td>
                        <select id="formAluno_Vinculo" class="text ui-widget-content ui-corner-all">
                            <option value="{{$aluno.vinculo}}">{{$aluno.vinculo}}</option>
...
<table>
    <tr>
        <td><button id="{{$aluno.idAluno}}" onclick="atualizar(id)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all">Atualizar</button></td>
...
*/  
      ...
      $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/aluno/atualizar",
                data: {
                    "idAluno": idAluno,
