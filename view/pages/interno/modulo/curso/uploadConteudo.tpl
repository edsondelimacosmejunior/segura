...
<input type="text" id="idCurso" name="idCurso" value="{{$curso.idCurso}}" style="display: none;" />
            ...
            <tr>
                <td>
                    ...
                    <fieldset style="background-color: whitesmoke;">
                        ...
                        <form enctype="multipart/form-data" id="form" action="{{$BASE_PATH}}interno/modulo/curso/uploadConteudo" method="post">
...
<script type="text/javascript" charset="utf-8">
    ...
    function cadastrar() {
        ...
        if (contador == 0) {
            ...
            //ESTA FUNÇÃO
            $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/curso/armazenarConteudo",
                data: {
                    "idCurso": $("#idCurso").val(),
                    "extensao": ($("#userfile").val().substring($("#userfile").val().lastIndexOf("."))).toLowerCase()
                },
