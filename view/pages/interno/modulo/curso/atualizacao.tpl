        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formCurso_Nome" size="70" maxlength="255" value="{{$curso.nome}}"/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_CargaHoraria">Carga Horária:</label></td>
                    <td><input type="text" id="formCurso_CargaHoraria" size="70" maxlength="255" value="{{$curso.cargaHoraria}}"/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_Conteudo">Conteúdo:</label></td>
                    <td><input type="text" id="formCurso_Conteudo" size="70" value="{{$curso.conteudo}}"/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_Validade">Validade:</label></td>
                    <td><input type="text" id="formCurso_Validade" size="70" maxlength="255" value="{{$curso.validade}}"/></td>
                </tr>
            </table>
        </fieldset>
    </div> 
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table>    
                <tr>
                    ...
                    <td><input type="color" id="formCurso_CorFundo" size="70" value="{{$curso.corFundo}}"/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_CorFonte">Cor da Fonte do Título:</label></td>
                    <td><input type="color" id="formCurso_CorFonte" size="70" value="{{$curso.corFonte}}"/></td>
                </tr>
                <tr>
                    <td><label for="formCurso_TamanhoFonte">Tamanho da Fonte do Título:</label></td>
                    <td>
                        <select id="formCurso_TamanhoFonte">
                            <option value="{{$curso.tamanhoFonte}}">{{$curso.tamanhoFonte}} px</option>
...
<table>
    <tr>
        <td><button id="{{$curso.idCurso}}" onclick="atualizar(id);" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all">Atualizar</button></td>
...
<script>
    ...
    function atualizar(idCurso){
        ...
        $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/curso/atualizar",
                data: {
                    "idCurso": idCurso,
