<script type="text/javascript">
    ...
    function filtrar() {
        ...
        $.ajax({
            url: "{{$BASE_PATH}}interno/modulo/financeiro/relatorios/fluxocaixa/filtrar/",
            data: {
                "mes": $("#mes").val(),
                "ano": $("#ano").val()
            },
...
<script>
    ...
    function getReceitas(idTipoLancamento, dia, mes, ano) {
        ...
        $.ajax({
            url: "{{$BASE_PATH}}interno/modulo/financeiro/relatorios/fluxocaixa/getReceitas",
            data: {
    ...
    function getDespesas(idTipoLancamento, dia, mes, ano) {
        ...
        $.ajax({
            url: "{{$BASE_PATH}}interno/modulo/financeiro/relatorios/fluxocaixa/getDespesas",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "dia": dia,
                "mes": mes,
    ...
    function getReceitasTotal(idTipoLancamento, mes, ano) {
        ...
        $.ajax({
            url: "{{$BASE_PATH}}interno/modulo/financeiro/relatorios/fluxocaixa/getReceitasTotal",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "mes": mes,
                "ano": ano
    ...
    function getDespesasTotal(idTipoLancamento, mes, ano) {
        ...
        $.ajax({
            url: "{{$BASE_PATH}}interno/modulo/financeiro/relatorios/fluxocaixa/getDespesasTotal",
            data: {
                "idTipoLancamento": idTipoLancamento,
                "mes": mes,
                "ano": ano
