...
<script>$("#statusInformacao").html("Você está em: Financeiro >> Relatórios >> Despesa.");</script>
...
<div id="resultado-contain" style="display: none">
    ...
    <div id="formulario">
        <form action="../extensions/excel/modeloGCPHPEXCEL.php" method="post" id="excel" style="display: none;">
            ...
            <input type="text" id="cabecalhoEXCEL" name="cabecalhoEXCEL" value="<th>#</th><th>Fornecedor</th><th>Despesa</th><th>Data de Emissão</th><th>Data de Vencimento</th><th>Valor Original</th><th>Valor Baixado</th><th>Data de Baixa</th><th>Tipo de Lançamento</th>" />
...
<script type="text/javascript" charset="utf-8">
    ...
    function gerarRelatorio() {
        ...
        if (contador == 0) {
            ...
            $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/financeiro/relatorios/despesa/gerar",
                data: {
    ...
    function exportarExcel() {
        ...
        //alert(pegaCodigo);
        $("#nomeEXCEL").val("Relatorio_Despesa");
