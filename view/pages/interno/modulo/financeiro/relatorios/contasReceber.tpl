...
<script>$("#statusInformacao").html("Você está em: Financeiro >> Relatórios >> Contas a Receber.");</script>
    ...
    <table id="relatorio" class="ui-widget ui-widget-content">
        <thead>
            <tr class="ui-widget-header ">
                <th>Relatório de Contas a Receber</th>
            </tr>
        </thead>
        <tbody>
            <tr>
...
<script type="text/javascript" charset="utf-8">
    ...
    function gerarRelatorio() {
        ...
        if (contador == 0) {
            ...
            $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/financeiro/relatorios/contasreceber/gerar",
                data: {
    ...
    function exportarExcel() {
        ...
        //alert(pegaCodigo);
        $("#nomeEXCEL").val("Relatorio_Contas_Receber");
