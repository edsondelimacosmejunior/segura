<script type="text/javascript">
    ...
    function filtrar() {
        ...
        $.ajax({
            url: "{{$BASE_PATH}}interno/modulo/financeiro/relatorios/fluxocaixasede/filtrar/",
            data: {
                "mes": $("#mes").val(),
                "ano": $("#ano").val()
            },
    ...
    function limpar() {
        openlink("{{$BASE_PATH}}interno/modulo/financeiro/relatorios/fluxocaixasede/mostrar/");
    }
