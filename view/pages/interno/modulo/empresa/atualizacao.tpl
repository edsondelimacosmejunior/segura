...
<script>$("#statusInformacao").html("Vocé está em: Empresa >> Listar Empresas >> Atualizar Cadastro de Empresa.");</script>

<div id="tabs_atualizacaoEmpresa">
    <ul>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formEmpresa_NomeFantasia" size="70" maxlength="255" value="{{$empresa.nomeFantasia}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_RazaoSocial">Razão Social:</label></td>
                    <td><input type="text" id="formEmpresa_RazaoSocial" size="70" maxlength="255" value="{{$empresa.razaoSocial}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Cnpj">CNPJ:</label></td>
                    <td><input type="text" id="formEmpresa_Cnpj" size="70" maxlength="18" onKeyDown="Mascara(this,Cnpj);" onKeyPress="Mascara(this,Cnpj);" onKeyUp="Mascara(this,Cnpj);"  value="{{$empresa.cnpj}}"/></td>
                </tr>
            </table>
        </fieldset>
    </div>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formEmpresa_Rua" size="70" maxlength="255" value="{{$empresa.rua}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Numero">Número:</label></td>
                    <td><input type="text" id="formEmpresa_Numero" size="70" maxlength="10" onKeyDown="Mascara(this,Inteiro);" onKeyPress="Mascara(this,Inteiro);" onKeyUp="Mascara(this,Inteiro);" value="{{$empresa.numero}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Bairro">Bairro:</label></td>
                    <td><input type="text" id="formEmpresa_Bairro" size="70" maxlength="255" value="{{$empresa.bairro}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Cep">CEP:</label></td>
                    <td><input type="text" id="formEmpresa_Cep" size="70" maxlength="9" onKeyDown="Mascara(this,Cep);" onKeyPress="Mascara(this,Cep);" onKeyUp="Mascara(this,Cep);" value="{{$empresa.cep}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Cidade">Cidade:</label></td>
                    <td><input type="text" id="formEmpresa_Cidade" size="70" maxlength="255" value="{{$empresa.cidade}}"/></td>
                </tr>
                <tr>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formEmpresa_Contato" size="70" maxlength="255" value="{{$empresa.contato}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Email">Email:</label></td>
                    <td><input type="text" id="formEmpresa_Email" size="70" maxlength="255" value="{{$empresa.email}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Telefone1">Telefone Principal:</label></td>
                    <td><input type="text" id="formEmpresa_Telefone1" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="{{$empresa.telefone1}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Telefone2">Telefone Secundário:</label></td>
                    <td><input type="text" id="formEmpresa_Telefone2" size="70" maxlength="14" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="{{$empresa.telefone2}}"/></td>
                </tr>
            </table>
        </fieldset>
    </div>
        ...
        <fieldset style="background-color: whitesmoke;">
            ...
            <table> 
                <tr>
                    ...
                    <td><input type="text" id="formEmpresa_InscricaoEstadual" size="70" maxlength="255" value="{{$empresa.inscricaoEstadual}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_InscricaoMunicipal">Incrição Municipal:</label></td>
                    <td><input type="text" id="formEmpresa_InscricaoMunicipal" size="70" maxlength="255" value="{{$empresa.inscricaoMunicipal}}"/></td>
                </tr>
                <tr>
                    <td><label for="formEmpresa_Observacao">Observações:</label></td>
                    <td><input type="text" id="formEmpresa_Observacao" size="70" maxlength="255" value="{{$empresa.observacao}}"/></td>
                </tr>           
            </table>
        </fieldset>
    </div>    
...
<table>
    <tr>
        <td><button id="{{$empresa.idEmpresa}}" onclick="atualizar(id)" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all">Atualizar</button></td>
...
<script>
    ...
    function atualizar(idEmpresa){
      ...
      $.ajax({
                url: "{{$BASE_PATH}}interno/modulo/empresa/atualizar",
                data: {
                    "idEmpresa": idEmpresa,
