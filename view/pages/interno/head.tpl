...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script src="{{$JS}}validadores.js" type="text/javascript"></script>
                ...
                <link href="{{$CSS}}data-tables/demo_table.css" rel="stylesheet" type="text/css" />
                
                <link type="text/css" href="{{$CSS}}novoMenu.css" rel="stylesheet" />
                <script type="text/javascript" src="{{$JS}}novoMenu.js"></script>
