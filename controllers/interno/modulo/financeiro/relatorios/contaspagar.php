 ...
 * @package Controllers
 */
Class Controller_Contaspagar extends Proto_Controller {
    ...
    function mostrar() {
        ...
        //Abre a página
        $this->show("pages/interno/modulo/financeiro/relatorios/contasPagar.tpl");
    }
    ...
    function gerar() {
        ...
        $lancamentos = Doctrine_Query::create()
                ...
                ->where("l.status like 'Pendente' and l.pagarReceber = 0 and l.dataVencimento >= '$dataInicial' and l.dataVencimento <= '$dataFinal' $complementoSql")
                ->execute()
                ->toArray();
