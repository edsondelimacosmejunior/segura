...
Class Controller_Despesa extends Proto_Controller {
    ...
    function mostrar() {
        ...
        //Abre a página
        $this->show("pages/interno/modulo/financeiro/relatorios/despesa.tpl");
    }
    ...
    function gerar() {
        ...
        $lancamentos = Doctrine_Query::create()
                ...
                ->where("l.status not like 'Excluido' and l.pagarReceber = 0 and l.dataVencimento >= '$dataInicial' and l.dataVencimento <= '$dataFinal' $complementoSql")
                ->execute()
                ->toArray();
