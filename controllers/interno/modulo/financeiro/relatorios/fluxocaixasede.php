 ...
 * @package Controllers
 */
Class Controller_Fluxocaixasede extends Proto_Controller {
    ...
    function mostrar() {
        ...
        $lancamentos = Doctrine_Query::create()
                ...
                ->where("l.status like 'Baixado' and l.origemNotaFiscal = 0 and l.dataBaixa >= '" . $ano . "-" . $mes . "-01' and l.dataBaixa <= '" . $ano . "-" . $mes . "-" . $dias_do_mes . "'")
