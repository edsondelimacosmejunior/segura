                ...
                <div style="border: 3px solid #ed5d16; margin: 4px;">
                    <table height="214" cellspacing="0" cellpadding="3" border="1" style="width:331px; border: 2px solid #59A270; border-collapse:collapse;">
                        <tbody>
                            ...
                            <tr>
                                <td style="background:<?php echo($matricula[0]["corFundo"]) ?>; border:2px solid #59A270; height:40px; text-align:center; font-size:<?php echo($matricula[0]["tamanhoFonte"]) ?>px; color:<?php echo($matricula[0]["corFonte"]) ?>; font-weight:bold; font-family:'Arial Black', Gadget, sans-serif;" colspan="3">
                                    <?php echo($matricula[0]["curso"]) ?>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td height="20" style="border:2px solid #59A270;">
                                    ...
                                    <div style="text-align:Left; font-size:11px;  color:#000; font-weight:bold; font-family:Arial, Helvetica, sans-serif; margin-top: -2px;margin-bottom: -2px;">
                                        <?php echo($matricula[0]["dataTurma"]) ?>            
                                    </div>
                                </td>
                                <td style="border:2px solid #59A270;">
                                    ...
                                    <div style="text-align:Left; font-size:11px; color:#000; font-weight:bold; font-family:Arial, Helvetica, sans-serif;">
                                        <?php echo($matricula[0]["cargaHoraria"]) ?>
                                    </div>
                                </td>
                                <td style="border:2px solid #59A270;">
                                    ...
                                    <div style="text-align:Left; font-size:11px;  color:#000; font-weight:bold; font-family:Arial, Helvetica, sans-serif; margin-top: -2px;margin-bottom: -2px;">
                                        <?php 
                                            if (strcmp($matricula[0]["cpf"], "") != 0) {
                                                echo($matricula[0]["cpf"]); 
                                            }else{
                                                echo($matricula[0]["matpetrobras"]); 
                                            }
                                        ?>            
                                    </div>
                                </td>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="height: 145px; width: 250px">
                                                    <img width="225" src="../../view/imgs/uploads/<?php echo($matricula[0]["patchConteudo"]) ?>"  alt="Grade Curricular" />
                                                </td>
                                                <td valign="top" style="height: 70px; width: 70px; text-align:center; color:#000; font-size:11px; font-weight:bold; font-family:Verdana, Geneva, sans-serif;">
                                                    <img src="http://chart.apis.google.com/chart?cht=qr&chl=<?php echo('CPF=' . $matricula[0]["cpf"] . '/MAT=' . $matricula[0]["idMatricula"] . ''); ?>&chs=80x80" alt="Segura - QR code"/>
                                                    <?php echo($matricula[0]["idMatricula"]) ?>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                            ...
                            <tr>
                                <td valign="top" height="50" style="border: 2px solid #59A270; border-collapse:collapse; font-family:Arial, Helvetica, sans-serif;" colspan="3">
                                    ...
                                    <div style="text-align:center; font-size:10px; float:right;">
                                        <b>Local:</b><?php echo($matricula[0]["local"]) ?>            
                                    </div>
                                    ...
                                    <div style="color:#000; font-size:11px; font-family:Arial, Helvetica, sans-serif; text-align:center; margin-top: 15px;">
                                        <table height="30" style="width:300px;">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="../../view/imgs/uploads/<?php echo($matricula[0]["idInstrutor3"]); ?>" alt="Assinatura" width="75px" height="25px;" />
                                                    </td>
                                                    <td>
                                                        <img src="../../view/imgs/uploads/<?php echo($matricula[0]["idInstrutor1"]); ?>" alt="Assinatura" width="75px" height="25px;" />
                                                    </td>
                                                    <td>
                                                        <img src="../../view/imgs/uploads/<?php echo($matricula[0]["idInstrutor2"] ); ?>" alt="Assinatura" width="75px" height="25px;" />
                                                    </td>
                                                    <td>
                                                        <img src="../../view/imgs/uploads/<?php echo($matricula[0]["idInstrutor4"]); ?>" alt="Assinatura" width="75px" height="25px;" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
