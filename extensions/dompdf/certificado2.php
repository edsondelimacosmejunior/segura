...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <style>
        ...
        .corpo{
            ...
            text-align: left;
            font-size: 13px;
            background-image: url("certificado4.jpg");
        }
        ...
        <div class="corpo">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style=" height=50px; width: 85px;">
                                <div style="color:#59A270; font-size:12px; font-weight:bold; font-family:"Arial Black", Helvetica, sans-serif; position:relative; margin-left: 8px;float: left; width: 110px">Consultoria e Treinamento</div>
                            </td>
                            <td height="50">
            ...
            <div id="ladoDireito">
                <div id="ladoDireitoA">
                    ...
                    <div id="grade">
                        <img src="../../view/imgs/uploads/' . $matricula[0]["patchConteudo"] . '" alt="Grade Curricular" width="220px"; height="100px;" />
                    </div>
                </div>
                <div id="ladoDireitoB">
                    <div id="qrcode">
